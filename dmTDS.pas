...
{$ENDIF}
	...
	tblmEvent.FieldDefs.Add('GenderStr', ftString, 1); // DolphinT. DO4 A=boys, B=girls, X=any.
	tblmEvent.FieldDefs.Add('RoundStr', ftString, 1); // DolphinT. Round A for all, P for prelim or F for final.
