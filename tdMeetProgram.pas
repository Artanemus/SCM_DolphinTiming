...
function BuildAndSaveMeetProgramDolphinTiming(AFileName: string): Boolean;
...
begin
  ...
  begin
    ...
    s := s + IntToStr(i) + ',';
    // Event Name  Up to 25 alpha-numeric characters. Example: Mens 50 Meter Freestyle
  ...
  SCM.qryEvent.First();
  if not sl.IsEmpty then sl.SaveToFile(AFileName);
  sl.free;
end;
